namespace System.Collections.ObjectModel
{
    ...
    public class ObservableRangeCollection<T> : ObservableCollection<T>
    {
        ...
        public void InsertRange(int index, IEnumerable<T> collection)
        {
            ...
            OnCollectionChanged(new Specialized.NotifyCollectionChangedEventArgs(Specialized.NotifyCollectionChangedAction.Add, list, index));
        }
        ...
        public void RemoveRange(IEnumerable<T> collection)
        {
            ...
            if (Count == 0)
                ...
                foreach (KeyValuePair<int, List<T>> cluster in clusters)
                    OnCollectionChanged(new Specialized.NotifyCollectionChangedEventArgs(Specialized.NotifyCollectionChangedAction.Remove, cluster.Value, cluster.Key));
        ...
        public int RemoveAll(int index, int count, Predicate<T> match)
        {
            ...
            using (DeferEvents())
            {
                for (var i = 0; i < count; i++, index++)
                {
                    ...
                    {
                        OnCollectionChanged(new Specialized.NotifyCollectionChangedEventArgs(Specialized.NotifyCollectionChangedAction.Remove, cluster, clusterIndex));
                        clusterIndex = -1;
                        cluster = null;
                    }
                }
        ...
        public void RemoveRange(int index, int count)
        {
            ...
            if (Count == 0)
                ...
                OnCollectionChanged(new Specialized.NotifyCollectionChangedEventArgs(Specialized.NotifyCollectionChangedAction.Remove, removedItems, index));
        }
            ...
            using (DeferEvents())
            {
                ...
                if (count != addedCount)
                {
                    ...
                    if (count > addedCount)
                    {
                        ...
                        OnCollectionChanged(new Specialized.NotifyCollectionChangedEventArgs(Specialized.NotifyCollectionChangedAction.Remove, removed, i));
                    }
                    else
                    {
                        var k = i - index;
                        ...
                        OnCollectionChanged(new Specialized.NotifyCollectionChangedEventArgs(Specialized.NotifyCollectionChangedAction.Add, added, i));
                    }
        ...
        protected override void SetItem(int index, T item)
        {
            ...
            OnIndexerPropertyChanged();
            OnCollectionChanged(Specialized.NotifyCollectionChangedAction.Replace, originalItem, item, index);
        }
        ...
        /// </summary>
        private void OnCollectionChanged(Specialized.NotifyCollectionChangedAction action, object oldItem, object newItem, int index) =>
          OnCollectionChanged(new Specialized.NotifyCollectionChangedEventArgs(action, newItem, oldItem, index));
        ...
        private void OnRangeReplaced(int followingItemIndex, ICollection<T> newCluster, ICollection<T> oldCluster)
        {
            ...
            OnCollectionChanged(
                new Specialized.NotifyCollectionChangedEventArgs(
                    Specialized.NotifyCollectionChangedAction.Replace,
        ...
        private sealed class DeferredEventsCollection : List<Specialized.NotifyCollectionChangedEventArgs>, IDisposable
        {
